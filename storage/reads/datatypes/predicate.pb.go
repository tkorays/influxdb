...
func (Node_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_predicate_fff468ecd57341b2, []int{0, 0}
}
...
func (Node_Comparison) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_predicate_fff468ecd57341b2, []int{0, 1}
}
...
func (Node_Logical) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_predicate_fff468ecd57341b2, []int{0, 2}
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_predicate_fff468ecd57341b2, []int{0}
}
...
func (*Predicate) Descriptor() ([]byte, []int) {
	return fileDescriptor_predicate_fff468ecd57341b2, []int{1}
}
...
func init() { proto.RegisterFile("predicate.proto", fileDescriptor_predicate_fff468ecd57341b2) }

var fileDescriptor_predicate_fff468ecd57341b2 = []byte{
